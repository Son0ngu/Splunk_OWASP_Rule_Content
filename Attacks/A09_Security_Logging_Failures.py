...
PAYLOADS = [
    ...
    # --- Advanced: Terminal/Splunk XSS & Command Injection over Logs ---
    ...
    # --- Advanced: Overwhelming the SIEM (Buffer Bloat & Path Confusion) ---
    'A' * 2000, 
    'B' * 5000, 
