...
PAYLOADS_CMD = [
    # --- Basic: Chaining Commands (Linux/Windows) ---
    ...
    # --- Medium: Exfiltration & Downloading Files ---
    ...
    # --- Advanced: WAF Bypasses (Space bypass, Encoding, Obfuscation) ---
    ...
    # --- Advanced: Reverse Shells (Interactive Access) ---
